...
RSpec.configure do |config|
  ...
  # MPH Include Factory-Girl support
  ...
  # MPH Change to false for database_cleaner support, we don't want AR to
  # wrap tests in transactions.
  config.use_transactional_fixtures = false

  # MPH database_cleaner configuration
